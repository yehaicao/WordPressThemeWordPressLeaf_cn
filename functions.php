...
function  demo_function($atts, $content = null) {
  ...
  $leaf = trim($leaf) ? trim($leaf) :  'leaf';
	...
	$return_string='<a class="leafdl" href="'.$href.'"><i class="fa fa-'.$leaf.'"></i>  '.$content.'</a>';
...
function leaf_cdn_replace($html){
	$local_host = 'http://www.wordpressleaf.com'; //博客域名
	$leaf_host = 'http://static.estory365.com'; //七牛域名
